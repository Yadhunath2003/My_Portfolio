...
const Icon = ({ name }) => {
  ...
  switch (name) {
    case "shield":
      return <svg viewBox="0 0 24 24"><path fill="currentColor" d="M12 2l7 3v6c0 5-3.4 9.7-7 11-3.6-1.3-7-6-7-11V5l7-3zm0 2.2L7 5.3v5.4c0 4 2.7 7.9 5 9 2.3-1.1 5-5 5-9V5.3l-5-1.1z"/></svg>;
    case "aws":
